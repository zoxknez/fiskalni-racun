...
export default {
  ...
  theme: {
    ...
    extend: {
      // ⭐ Modern color system with semantic names
      colors: {
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
      ...
      // ⭐ Fluid typography
      fontSize: {
        'fluid-xs': 'clamp(0.75rem, 0.7rem + 0.15vw, 0.875rem)',
        ...
        'fluid-xl': 'clamp(1.25rem, 1.1rem + 0.7vw, 1.875rem)',
        'fluid-2xl': 'clamp(1.5rem, 1.3rem + 1vw, 2.25rem)',
        'fluid-3xl': 'clamp(1.875rem, 1.5rem + 1.5vw, 3rem)',
        'fluid-4xl': 'clamp(2.25rem, 1.8rem + 2vw, 3.75rem)',
      },

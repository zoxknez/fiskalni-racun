  ...
  sr: {
    translation: {
      ...
      addReceipt: {
        ...
        sharedFile: 'Podeljeni fajl',
        sharedSavedAsNote: 'Deljeni fajl je dodat u napomenu (pregled nije moguć).',
        unsupportedFile: 'PDF nije podržan za prikaz, sačuvan je kao napomena.',
        sharedLoaded: 'Deljeni sadržaj je učitan.',
        errors: {
          unsupportedFileType: 'Nepodržan tip fajla. Molimo koristite slike.',
          fileTooLarge: 'Fajl je prevelik. Maksimalna veličina je 4.5MB.',
          loadTimeout: 'Vreme učitavanja slike je isteklo.',
          imageTooLarge: 'Slika je prevelika. Maksimalne dimenzije: {{width}}x{{height}}px.',
          previewFailed: 'Greška pri kreiranju pregleda slike.',
          imageCorrupted: 'Greška pri učitavanju slike. Fajl je možda oštećen.',
          processingFailed: 'Greška pri obradi slike.',
        },
        household: {
          providerInfo: 'Informacije o dobavljaču',
          amountPeriod: 'Iznos i period',
          dueStatus: 'Rok i status',
      ...
      validation: {
        ...
        amountMax: 'Iznos je prevelik',
        dateRequired: 'Datum je obavezan',
        timeInvalid: 'Nevalidan format vremena',
        vatAmountNonNegative: 'PDV ne može biti negativan',
        categoryRequired: 'Kategorija je obavezna',
        notesMaxLength: 'Napomena je preduga (maksimalno {{max}} karaktera)',
        urlInvalid: 'Nevažeći URL',
        pibInvalid: 'PIB mora imati 9 cifara',
        ...
        brandMaxLength: 'Brend je predug',
        modelRequired: 'Model je obavezan',
        modelMaxLength: 'Model je predug',
        serialNumberMaxLength: 'Serijski broj je predug',
        warrantyDurationInt: 'Mora biti ceo broj',
        warrantyDurationNonNegative: 'Ne može biti negativan',
        warrantyDurationMax: 'Maksimalno 120 meseci (10 godina)',
        serviceNameMaxLength: 'Naziv servisa je predug',
        serviceAddressMaxLength: 'Adresa servisa je preduga',
        servicePhoneInvalid: 'Nevažeći format telefona',
        servicePhoneMaxLength: 'Telefon je predug',
        serviceHoursMaxLength: 'Radno vreme je predugo',
        queryMaxLength: 'Upit je predug',
        amountMinMax: 'Minimalni iznos ne može biti veći od maksimalnog',
      },
      ...
      importPage: {
        ...
        noItemsToSync: 'Nema stavki za čuvanje',
        itemsAwaitingSync: '{{count}} stavki čeka sinhronizaciju',
        enqueueFailed: 'Greška pri pripremi podataka za čuvanje',
        syncInProgress: 'Sinhronizacija u toku...',
        itemsRemaining: '{{count}} stavki preostalo',
        goToReceipts: 'Idi na račune',
        syncComplete: 'Sinhronizacija završena!',
        syncCompleteDescription: 'Svi podaci su uspešno sačuvani na vaš nalog.',
        viewReceipts: 'Pogledaj račune',
      },
      ...
      tags: {
        ...
        hitno: 'Hitno',
        planiran: 'Planiran',
        errorCreating: 'Greška pri kreiranju oznake',
        errorUpdating: 'Greška pri ažuriranju oznake',
        errorDeleting: 'Greška pri brisanju oznake',
      },
      ...
      subscriptions: {
        title: 'Pretplate',
        subtitle: 'Upravljaj svojim pretplatama na jednom mestu',
        manageSmart: 'Pametno upravljanje',
        heroTitle: 'Tvoje Pretplate',
        heroSubtitle: 'Sve pretplate na jednom mestu. Kontroliši troškove.',
        monthly: 'Mesečno',
        add: 'Dodaj pretplatu',
        addNew: 'Nova pretplata',
        edit: 'Izmeni pretplatu',
        deleteTitle: 'Obriši pretplatu',
        deleteConfirm: 'Da li si siguran da želiš da obrišeš "{{name}}"?',
        empty: 'Još nemaš pretplate',
        emptyHint: 'Dodaj prvu pretplatu klikom na dugme iznad',
        name: 'Naziv',
        provider: 'Provajder',
        amount: 'Iznos',
        billingCycle: 'Period',
        category: 'Kategorija',
        nextBillingDate: 'Sledeća naplata',
        startDate: 'Datum početka',
        reminderDays: 'Podsetnik (dana pre naplate)',
        cancelUrl: 'Link za otkazivanje',
        loginUrl: 'Link za prijavu',
        notes: 'Napomena',
        notesPlaceholder: 'Dodatne informacije...',
        monthlyTotal: 'Mesečno',
        yearlyTotal: 'Godišnje',
        activeCount: 'Aktivne',
        upcoming: 'Uskoro',
        upcomingAlert: 'Pretplate koje se uskoro naplaćuju',
        today: 'Danas',
        inDays: 'Za {{days}} dana',
        overdue: 'Zakasnelo',
        paused: 'Pauzirano',
        ...
        customProvider: 'Druga pretplata...',
        cycle: {
          weekly: 'Nedeljno',
          monthly: 'Mesečno',
          quarterly: 'Kvartalno',
      ...
      // Community Deals
      deals: {
        title: 'Zajedničke Ponude',
        subtitle: 'Podelite i otkrijte najbolje ponude u zajednici',
        community: 'Zajednica deli',
        heroTitle: 'Otkrij Najbolje Ponude',
        heroSubtitle: 'Pronađi neverovatne popuste koje su članovi zajednice podelili',
        totalDeals: 'Aktivnih ponuda',
        avgDiscount: 'Prosečan popust',
        hotDeals: 'Hot ponuda',
        add: 'Podeli ponudu',
        addNew: 'Nova ponuda',
        share: 'Podeli',
        deleteTitle: 'Obriši ponudu',
        deleteConfirm: 'Da li si siguran da želiš da obrišeš ovu ponudu?',
        empty: 'Još nema ponuda',
        emptyHint: 'Budi prvi koji će podeliti sjajnu ponudu!',
        searchPlaceholder: 'Pretraži ponude...',
        allCategories: 'Sve',
        loginRequired: 'Morate biti prijavljeni',
        storeRequired: 'Prodavnica je obavezna',
        dealTitle: 'Naslov ponude',
        titlePlaceholder: 'npr. iPhone 15 Pro - 20% popust',
        description: 'Opis',
        descriptionPlaceholder: 'Opišite ponudu detaljnije...',
        store: 'Prodavnica',
        storePlaceholder: 'npr. Gigatron, Tehnomanija...',
        category: 'Kategorija',
        priceInfo: 'Informacije o ceni',
        originalPrice: 'Stara cena',
        discountedPrice: 'Nova cena',
        discountPercent: 'Popust %',
        isOnline: 'Online ponuda',
        type: 'Tip ponude',
        online: 'Online',
        inStore: 'U prodavnici',
        location: 'Lokacija',
        locationPlaceholder: 'npr. Beograd, TC Ušće',
        url: 'Link do ponude',
        expiresAt: 'Važi do',
        validUntil: 'Do',
        savings: 'Ušteda',
      ...
      calendar: {
        ...
        bills: 'Računi (dug.)',
        eventReceipt: 'Račun',
        eventWarrantyExpiry: 'Garancija ističe',
        eventDocumentExpiry: 'Dokument ističe',
        eventBillDue: 'Račun dospeva',
        dayMon: 'Pon',
        dayTue: 'Uto',
        dayWed: 'Sre',
        dayThu: 'Čet',
      ...
      sync: {
        ...
        online: 'Online',
        offlineError: 'Niste povezani na internet',
        syncingData: 'Sinhronizacija podataka...',
        syncComplete: 'Sinhronizovano {{count}} stavki',
        pull: 'Preuzmi',
        push: 'Pošalji',
        fullSync: 'Potpuna sinhronizacija',
        pulling: 'Preuzimanje podataka...',
        pushing: 'Slanje podataka...',
        fullSyncing: 'Potpuna sinhronizacija...',
        pullSuccess: 'Preuzeto {{count}} novih stavki',
        pushSuccess: 'Poslato {{count}} stavki',
        fullSyncSuccess: 'Sinhronizacija uspešna!',
        pullFailed: 'Greška pri preuzimanju',
        pushFailed: 'Greška pri slanju',
        fullSyncFailed: 'Greška pri sinhronizaciji',
        upToDate: 'Podaci su ažurirani',
        pendingItems: '{{count}} stavki čeka na slanje',
        lastPull: 'Poslednje preuzimanje',
        lastPush: 'Poslednje slanje',
        queueEmpty: 'Red za sinhronizaciju je prazan',
        queueItems: 'Stavke u redu',
      },
    },
  },
  en: {
    translation: {
      ...
      importPage: {
        ...
        noItemsToSync: 'No items to save',
        itemsAwaitingSync: '{{count}} items awaiting sync',
        enqueueFailed: 'Error preparing data for saving',
        syncInProgress: 'Sync in progress...',
        itemsRemaining: '{{count}} items remaining',
        goToReceipts: 'Go to receipts',
        syncComplete: 'Sync complete!',
        syncCompleteDescription: 'All data has been saved to your account.',
      ...
      subscriptions: {
        ...
        manageSmart: 'Smart management',
        heroTitle: 'Your Subscriptions',
        heroSubtitle: 'All subscriptions in one place. Control your expenses.',
        monthly: 'Monthly',
        ...
        emptyHint: 'Add your first subscription by clicking the button above',
        name: 'Name',
        provider: 'Provider',
        amount: 'Amount',
        ...
        startDate: 'Start date',
        reminderDays: 'Reminder (days before billing)',
        cancelUrl: 'Cancellation link',
        loginUrl: 'Login link',
        notes: 'Notes',
        ...
        activeCount: 'Active',
        upcoming: 'Upcoming',
        upcomingAlert: 'Subscriptions billing soon',
        today: 'Today',
        inDays: 'In {{days}} days',
        overdue: 'Overdue',
        paused: 'Paused',
        ...
        customProvider: 'Other subscription...',
        cycle: {
          weekly: 'Weekly',
          monthly: 'Monthly',
          quarterly: 'Quarterly',
      ...
      deals: {
        ...
        subtitle: 'Share and discover the best deals in the community',
        community: 'Community shares',
        heroTitle: 'Discover Best Deals',
        heroSubtitle: 'Find amazing discounts shared by community members',
        ...
        empty: 'No deals yet',
        emptyHint: 'Be the first to share a great deal!',
        ...
        descriptionPlaceholder: 'Describe the deal in more detail...',
        store: 'Store',
        category: 'Category',
        originalPrice: 'Original price',
        discountedPrice: 'Sale price',
        discountPercent: 'Discount %',
        isOnline: 'Online deal',
        location: 'Location',
        url: 'Deal link',
      ...
      calendar: {
        ...
        eventWarrantyExpiry: 'Warranty expires',
        eventDocumentExpiry: 'Document expires',
        eventBillDue: 'Bill due',
        dayMon: 'Mon',
        dayTue: 'Tue',
        dayWed: 'Wed',
        dayThu: 'Thu',
      ...
      sync: {
        ...
        online: 'Online',
        offlineError: 'You are not connected to the internet',
        syncingData: 'Syncing data...',
        syncComplete: 'Synced {{count}} items',
        pull: 'Pull',
        push: 'Push',
        fullSync: 'Full Sync',
        pulling: 'Downloading data...',
        pushing: 'Uploading data...',
        fullSyncing: 'Full synchronization...',
        pullSuccess: 'Downloaded {{count}} new items',
        pushSuccess: 'Uploaded {{count}} items',
        fullSyncSuccess: 'Sync successful!',
        pullFailed: 'Download failed',
        pushFailed: 'Upload failed',
        fullSyncFailed: 'Sync failed',
        upToDate: 'Data is up to date',
        pendingItems: '{{count}} items waiting to sync',
        lastPull: 'Last download',
        lastPush: 'Last upload',
        queueEmpty: 'Sync queue is empty',

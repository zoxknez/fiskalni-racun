            ...
            {ocrProcessing ? (
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button onClick={handleTakePhoto} className="btn btn-secondary flex-1">
                    <Camera className="w-4 h-4" />
                    Nova slika
                  </button>
                  <button onClick={() => setMode('manual')} className="btn btn-primary flex-1">
                    Nastavi →
                  </button>
                </div>
              </div>
              ...
              <div className="empty-state">
                ...
                <button onClick={handleTakePhoto} className="btn-primary flex items-center gap-2">

...
export default function FilterPill({
  ...
  const variants = {
    primary: {
      ...
      inactive: 'bg-white dark:bg-dark-800 text-dark-700 dark:text-dark-300 border-2 border-dark-200 dark:border-dark-700 hover:border-primary-400 dark:hover:border-primary-600',
    ...
    success: {
      ...
      inactive: 'bg-white dark:bg-dark-800 text-dark-700 dark:text-dark-300 border-2 border-dark-200 dark:border-dark-700 hover:border-green-400 dark:hover:border-green-600',
      badge: 'bg-white/20 text-white',
    ...
    danger: {
      ...
      inactive: 'bg-white dark:bg-dark-800 text-dark-700 dark:text-dark-300 border-2 border-dark-200 dark:border-dark-700 hover:border-red-400 dark:hover:border-red-600',
      badge: 'bg-white/20 text-white',
    ...
    info: {
      ...
      inactive: 'bg-white dark:bg-dark-800 text-dark-700 dark:text-dark-300 border-2 border-dark-200 dark:border-dark-700 hover:border-blue-400 dark:hover:border-blue-600',
      badge: 'bg-white/20 text-white',

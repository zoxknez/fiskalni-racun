  ...
  sr: {
    translation: {
      ...
      addReceipt: {
        ...
        photo: 'Fotka',
        manual: 'Ručno',
        scanningQR: 'Skeniram QR kod...',
        qrNotRecognized: 'QR nije prepoznat — pokušaj ponovo ili dodaj fotku',
        takingPhoto: 'Snimam fotku...',
        processingOCR: 'Obrađujem OCR...',
        vendorRequired: 'Prodavac*',
        dateRequired: 'Datum*',
        amountRequired: 'Iznos*',
        selectCategory: 'Izaberi kategoriju',
        addNote: 'Dodaj napomenu...',
        save: 'Sačuvaj',
        cancel: 'Otkaži',
        requiredFields: 'Popuni obavezna polja',
        success: 'Račun dodat. Poveži garanciju ako kupovina sadrži uređaj.',
  ...
  en: {
    translation: {
      ...
      addReceipt: {
        ...
        qrNotRecognized: 'QR not recognized — try again or add photo',
        ...
        success: 'Receipt added. Link warranty if purchase contains device.',
